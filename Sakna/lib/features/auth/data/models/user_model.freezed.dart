...
@override
String toString() {
  return 'UserModel(id: $id, phone: $phone, name: $name, email: $email, gender: $gender, dateOfBirth: $dateOfBirth, avatarUrl: $avatarUrl, offersEnabled: $offersEnabled, isProfileComplete: $isProfileComplete)';
}
...
class _UserModel implements UserModel {
  const _UserModel({required this.id, required this.phone, this.name, this.email, this.gender, this.dateOfBirth, this.avatarUrl, this.offersEnabled = true, this.isProfileComplete = false});
